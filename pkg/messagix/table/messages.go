...
func (ls *LSDeleteThenInsertMessage) ToWrappedMessage() *WrappedMessage {
	return &WrappedMessage{
		LSInsertMessage: &LSInsertMessage{
			Text:                            ls.Text,
			SubscriptErrorMessage:           ls.SubscriptErrorMessage,
			AuthorityLevel:                  ls.AuthorityLevel,
			ThreadKey:                       ls.ThreadKey,
			TimestampMs:                     ls.TimestampMs,
			PrimarySortKey:                  ls.PrimarySortKey,
			SecondarySortKey:                ls.SecondarySortKey,
			MessageId:                       ls.MessageId,
			OfflineThreadingId:              ls.OfflineThreadingId,
			SenderId:                        ls.SenderId,
			StickerId:                       ls.StickerId,
			IsAdminMessage:                  ls.IsAdminMessage,
			MessageRenderingType:            ls.MessageRenderingType,
			SendStatus:                      ls.SendStatus,
			SendStatusV2:                    ls.SendStatusV2,
			IsUnsent:                        ls.IsUnsent,
			UnsentTimestampMs:               ls.UnsentTimestampMs,
			MentionOffsets:                  ls.MentionOffsets,
			MentionLengths:                  ls.MentionLengths,
			MentionIds:                      ls.MentionIds,
			MentionTypes:                    ls.MentionTypes,
			ReplySourceId:                   ls.ReplySourceId,
			ReplySourceType:                 ls.ReplySourceType,
			ReplySourceTypeV2:               ls.ReplySourceTypeV2,
			ReplyStatus:                     ls.ReplyStatus,
			ReplySnippet:                    ls.ReplySnippet,
			ReplyMessageText:                ls.ReplyMessageText,
			ReplyToUserId:                   ls.ReplyToUserId,
			ReplyMediaExpirationTimestampMs: ls.ReplyMediaExpirationTimestampMs,
			ReplyMediaUrl:                   ls.ReplyMediaUrl,
			ReplyMediaUnknownTimestampS:     ls.ReplyMediaUnknownTimestampS,
			ReplyMediaPreviewWidth:          ls.ReplyMediaPreviewWidth,
			ReplyMediaPreviewHeight:         ls.ReplyMediaPreviewHeight,
			ReplyMediaUrlMimeType:           ls.ReplyMediaUrlMimeType,
			ReplyMediaUrlFallback:           ls.ReplyMediaUrlFallback,
			ReplyCtaId:                      ls.ReplyCtaId,
			ReplyCtaTitle:                   ls.ReplyCtaTitle,
			ReplyAttachmentType:             ls.ReplyAttachmentType,
			ReplyAttachmentId:               ls.ReplyAttachmentId,
			ReplyAttachmentExtra:            ls.ReplyAttachmentExtra,
			IsForwarded:                     ls.IsForwarded,
			ForwardScore:                    ls.ForwardScore,
			HasQuickReplies:                 ls.HasQuickReplies,
			AdminMsgCtaId:                   ls.AdminMsgCtaId,
			AdminMsgCtaTitle:                ls.AdminMsgCtaTitle,
			AdminMsgCtaType:                 ls.AdminMsgCtaType,
			CannotUnsendReason:              ls.CannotUnsendReason,
			TextHasLinks:                    ls.TextHasLinks,
			ViewFlags:                       ls.ViewFlags,
			DisplayedContentTypes:           ls.DisplayedContentTypes,
			ViewedPluginKey:                 ls.ViewedPluginKey,
			ViewedPluginContext:             ls.ViewedPluginContext,
			QuickReplyType:                  ls.QuickReplyType,
			HotEmojiSize:                    ls.HotEmojiSize,
			PlatformXmdEncoded:              ls.PlatformXmdEncoded,
			SendAttributionXmd:              ls.SendAttributionXmd,
			ReplySourceTimestampMs:          ls.ReplySourceTimestampMs,
			EphemeralDurationInSec:          ls.EphemeralDurationInSec,
			MsUntilExpirationTs:             ls.MsUntilExpirationTs,
			EphemeralExpirationTs:           ls.EphemeralExpirationTs,
			TakedownState:                   ls.TakedownState,
			IsCollapsed:                     ls.IsCollapsed,
			SubthreadKey:                    ls.SubthreadKey,
			BotResponseID:                   ls.BotResponseID,
			MetadataDataclass:               ls.MetadataDataclass,
			EditCount:                       ls.EditCount,
			IsPaidPartnership:               ls.IsPaidPartnership,
			AdminSignatureName:              ls.AdminSignatureName,
			AdminSignatureProfileURL:        ls.AdminSignatureProfileURL,
			AdminSignatureCreatorType:       ls.AdminSignatureCreatorType,
			ReplyMessageHiddenState:         ls.ReplyMessageHiddenState,
			TranslatedText:                  ls.TranslatedText,
			TextDialect:                     ls.TextDialect,
			TranslatedTextDialect:           ls.TranslatedTextDialect,
			ScheduledTimestamp:              ls.ScheduledTimestamp,
			IsVideoQuickSend:                ls.IsVideoQuickSend,
			SubthreadParentMessageID:        ls.SubthreadParentMessageID,
			IsExclusiveToSubthread:          ls.IsExclusiveToSubthread,
		},
	}
}
