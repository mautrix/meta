...
require (
	...
	maunium.net/go/mautrix v0.24.1-0.20250530140943-e859fd833341
)
...
replace github.com/imroc/req/v3 => github.com/beeper/req/v3 v3.0.0-20250506132009-175df4a5aa23
