...
func (s *Socket) Connect() error {
	...
	if err != nil {
		return fmt.Errorf("failed to build brokerUrl: %v", err)
	}
...
func (s *Socket) sendData(data []byte) error {
	// TODO remove
	s.client.Logger.Trace().Str("data", base64.StdEncoding.EncodeToString(data)).Msg("DEBUG: Sending data to socket")
